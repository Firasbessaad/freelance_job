...
<!-- Form Name -->
<legend>التسجيل في التربص</legend>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">البريد الإلكتروني</label>  
  <div class="col-md-4">
  <input  name="mail" type="text" placeholder="البريد الإلكتروني" class="form-control input-md" required="">
...
<!-- Select Basic -->
<div class="form-group">
  <label class="col-md-4 control-label" for="selectbasic">نوع التربص</label>
  <div class="col-md-4">
    <select  name="stage" class="form-control" style="
    width: 164px;">
     
<?php 
$stages=afficher_satges();
while($stage = mysql_fetch_assoc($stages)){?>
 <option value="<?php echo $stage['id'] ;?>"><?php echo $stage['nom'] ;?></option> 
<?php
}?>
    </select>
  </div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button  name="inscription" >أسجل</button>
...
$mail=$_POST['mail'];
$stage=$_POST['stage'];
inscriptionStage($stage,$nom,$prenom,$age,$mail);
}
?>
<table class="xtable" width="100%" id="AutoNumber1f5">
    ...
    <tr>
      <td width="30%" class="xtr"> التربص</td>
      <td width="70%" class="xtd">وصف التربص</td>
    </tr>
<?php 
$stages=afficher_satges();
while($stage = mysql_fetch_assoc($stages)){
echo "<tr><td width=\"30%\" class=\"xtr\">".$stage['nom']."</td><td width=\"70%\" class=\"xtr\" >".$stage['description']."</td></tr>";
}?>
 </tbody></table>
