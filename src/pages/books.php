...
<table class="xtable" width="90%" id="AutoNumber1f5">
    <tbody>   
    <tr>
      <td width="30%" class="xtr"> الكتاب</td>
      <td width="70%" class="xtd">رابط التحميل</td>
    </tr>
<?php 
$fichiers=afficher_fichiers();
while($fichier = mysql_fetch_assoc($fichiers)){
echo "<tr><td width=\"30%\" class=\"xtr\">".$fichier['nom']."</td><td width=\"60%\" class=\"xtr\" ><a href=\"".$fichier['urlFtp']."\" download>أنقر هنا للتحميل</a></td></tr>";
}?>
 </tbody></table>
