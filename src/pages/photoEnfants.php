...
<a id="el3"  href="./photoEnfants"></a>
<a id="el4" href="./bricolage.php"></a>
<a id="el9"  href="./books.php"></a>
<a id="el2"  href="./stages.php"></a>
...
<div class="menus">
<div class="divtitle"><a href="./stages.php"><h2>تسجيل التربصات</h2></a></div>
...
<div class="divtitle"><a href="./books.php"><h2>مكتبة الوثائق</h2></a></div>
<div class="divtext"><div class="divtextpadding"><ul>
<?php
...
<div class="divtitle"><a href="./photoEnfants.php"><h2>فضاء الرسوم</h2></a></div>
<div class="divtext"><div class="divtextpadding"><ul>
<?php
...
<div class="menus">
<div class="divtitle"><a href="./bricolage.php"><h2>البراعة اليدوية</h2></a></div>
...
<!-- Form Name -->
<legend> إضافة رسوم</legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">الإسم</label>  
  <div class="col-md-4">
  <input name="prenom" type="text" placeholder="الإسم" class="form-control input-md" required="">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">اللقب</label>  
  <div class="col-md-4">
  <input name="nom" type="text" placeholder="اللقب" class="form-control input-md" required="">
...
<!-- Select Basic -->
<div class="form-group">
  <label class="col-md-4 control-label" for="selectbasic">العمر</label>
  <div class="col-md-4">
...
<!-- File Button --> 
<div class="form-group">
  <label class="col-md-4 control-label" for="filebutton">إختر صورتك</label>
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button name="ajouterPhoto" >أسجل</button>
...
$prenom=$_POST['prenom'];
$age=$_POST['age'];
$target_dir = "../photoEnfants/";
$nomphoto= "./photoEnfants/" . basename($_FILES["fileToUpload"]["name"]);
...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        echo "الصورة ". basename( $_FILES["fileToUpload"]["name"]). " تم تخزينها .";
    } else {
        echo "Sorry, there was an error uploading your file.";
    }
}
AjouterPhoto($nom,$prenom,$age,$nomphoto);
}
...
<table class="xtable" width="90%" id="AutoNumber1f5">
    <tbody>   
    <tr>
      <td width="20%" class="xtr"> الإسم</td>
      <td width="20%" class="xtd">اللقب</td>
      <td width="10%" class="xtd">العمر</td>
      <td width="50%" class="xtd">الرسم</td>
</tr>
<?php 
$photoEnfants=afficher_photoEnfants();

while($photoEnfant = mysql_fetch_assoc($photoEnfants)){
echo "<tr><td width=\"20%\" class=\"xtr\">".$photoEnfant['prenom']."</td><td width=\"20%\" class=\"xtr\" >".$photoEnfant['nom']."</td>
<td width=\"10%\" class=\"xtr\" >".$photoEnfant['age']."</td>
<td width=\"50%\" class=\"xtr\" ><img border=\"0\"  src=\".".$photoEnfant['img']."\" width=\"168\" height=\"88\"></td>
</tr>";
}?>
