...
<table class="xtable" width="90%" id="AutoNumber1f5">
    ...
    <tr>
      ...
      <td width="60%" class="xtd">الصورة</td>
      <td width="20%" class="xtd"></td>
    </tr><?php
$photoEnfants=afficher_nvphotoEnfants();
while($photoEnfant = mysql_fetch_assoc($photoEnfants)){
echo "<tr><td width=\"20%\" class=\"xtr\"><p>".$photoEnfant['prenom']." ".$photoEnfant['nom']." ".$photoEnfant['age']."سنة </p></td>
<td width=\"60%\" class=\"xtr\"><img border=\"0\" src=\"".$photoEnfant['img']."\" width=\"168\" height=\"88\" ></td>
<td width=\"20%\" class=\"xtr\" ><a href=\"#\" id=\"".$photoEnfant['id']."\" onclick=\"select(this.id);\" >تغيير/حذف</a></td></tr>";
}
$xphotoEnfants=afficher_photoEnfants();
while($photoEnfant = mysql_fetch_assoc($xphotoEnfants)){
echo "<tr><td width=\"20%\" class=\"xtr\"><p>".$photoEnfant['prenom']." ".$photoEnfant['nom']." ".$photoEnfant['age']."سنة </p></td>
<td width=\"60%\" class=\"xtr\"><img border=\"0\" src=\"".$photoEnfant['img']."\" width=\"168\" height=\"88\" ></td>
<td width=\"20%\" class=\"xtr\" ><a href=\"#\" id=\"".$photoEnfant['id']."\" onclick=\"supprimer(this.id);\" >حذف</a></td></tr>";
}
?>
</tbody></table>
<script>
...
accepterPhoto($idphoto);
}
if(isset($_POST['supprimer'])){
$idphoto=$_POST['idphoto'];
supprimerPhoto($idphoto);
}
