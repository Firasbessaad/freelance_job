...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button name="ajouterAdherents" >أسجل</button>
...
<?php
if(isset($_POST['ajouterAdherents'])){
$nom=$_POST['nom'];
$prenom=$_POST['prenom'];
$age=$_POST['age'];
$target_dir = "./photoadherent/";
$nomphoto= "./photoadherent/" . basename($_FILES["fileToUpload"]["name"]);
...
AjouterAdherents($nom,$prenom,$age,$nomphoto);
}


?><h1>قائمة المنخرطين</h1>

<table class="xtable" width="90%" id="AutoNumber1f5">
    <tbody>   
    <tr>
      <td width="30%" class="xtr"> إسم  </td>
      <td width="30%" class="xtd">اللقب</td>
...
<?php
$photoAdherants=afficher_photoAdherants();
while($adherant = mysql_fetch_assoc($photoAdherants)){
echo "<tr>
<td width=\"30%\" class=\"xtr\"><p>".$adherant['prenom']."</p></td>
<td width=\"30%\" class=\"xtr\"><p>".$adherant['nom']."</p></td>
<td width=\"10%\" class=\"xtr\"><p>".$adherant['age']."</p></td>
<td width=\"30%\" class=\"xtr\" ><a href=\"#\" id=\"".$adherant['id']."\" onclick=\"supprimer(this.id);\" >حذف</a></td></tr>";
}
?>
</tbody></table>
...
document.getElementById('idadherent').value=id;
...
<div class="form-group">
  ...
  <div class="col-md-8">
    ...
    <button id="Supprimer" name="supprimer" class="btn btn-danger">حذف</button>
  </div>
</div>
<br>
</fieldset>
