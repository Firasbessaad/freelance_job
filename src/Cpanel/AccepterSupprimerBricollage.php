...
<div id="contents">
<h1>البراعة اليدوية المقترحة</h1>

<br><br>

<div id="modif" class="modif" style="visibility:hidden;">
<form class="form-horizontal" action="" method="post">
<fieldset>
<!-- Form Name -->
<legend>موافقة / رفض</legend>
<input type="hidden" id="idbrico" name="idbrico">
<br><br>
<!-- Button (Double) -->
...
<table class="xtable" width="90%" id="AutoNumber1f5">
    <tbody>   
    <tr>
      <td width="20%" class="xtr"> الطفل </td>
      <td width="60%" class="xtd">البراعة</td>
      <td width="20%" class="xtd"></td>
    </tr><?php
$bricolages=afficher_nvbricolages();
while($bricolage = mysql_fetch_assoc($bricolages)){
echo "<tr><td width=\"20%\" class=\"xtr\"><p>".$bricolage['prenom']." ".$bricolage['nom']." ".$bricolage['age']."سنة </p></td>
<td width=\"60%\" class=\"xtr\"><img border=\"0\" src=\"".$bricolage['url']."\" width=\"168\" height=\"88\" ><p>".$bricolage['bricolageDescription']."</p></td>
<td width=\"20%\" class=\"xtr\" ><a href=\"#\" id=\"".$bricolage['id']."\" onclick=\"select(this.id);\" >تغيير/حذف</a></td></tr>";
}
$xbricolages=afficher_bricolages();
while($bricolage = mysql_fetch_assoc($xbricolages)){
echo "<tr><td width=\"20%\" class=\"xtr\"><p>".$bricolage['prenom']." ".$bricolage['nom']." ".$bricolage['age']."سنة </p></td>
<td width=\"60%\" class=\"xtr\"><img border=\"0\" src=\"".$bricolage['url']."\" width=\"168\" height=\"88\" ><p>".$bricolage['bricolageDescription']."</p></td>
<td width=\"20%\" class=\"xtr\" ><a href=\"#\" id=\"".$bricolage['id']."\" onclick=\"supprimer(this.id);\" >حذف</a></td></tr>";
}
?>
</tbody></table>
<script>
function select(id){
document.getElementById('idbrico').value=id;
document.getElementById('modif').style.visibility="visible";
}
function supprimer(id){
document.getElementById('idbrico').value=id;
document.getElementById('accepter').style.visibility="hidden";
document.getElementById('modif').style.visibility="visible";
}
</script>
...
$idbrico=$_POST['idbrico'];
accepterbrico($idbrico);
}
if(isset($_POST['supprimer'])){
$idbrico=$_POST['idbrico'];
supprimerbrico($idbrico);
}
