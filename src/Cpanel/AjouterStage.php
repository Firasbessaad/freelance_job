...
<!-- Form Name -->
<legend>إضافة تربص</legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="nomStage"> إسم التربص</label>  
  <div class="col-md-4">
  <input id="nomStage" name="nomStage" type="text" placeholder=" إسم التربص" class="form-control input-md" required="">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="textarea">المعطيات</label>
  <div class="col-md-4">                     
    <textarea class="form-control" id="textarea" name="StageDesc"></textarea>
  </div>
</div>
...
$nomStage=$_POST['nomStage'];
$StageDesc=$_POST['StageDesc'];

ajouterStage($nomStage,$StageDesc);
}
...
<table class="xtable" width="90%" id="AutoNumber1f5">
    <tbody>   
    <tr>
      <td width="20%" class="xtr"> التربص </td>
      <td width="50%" class="xtd">المعطيات</td>
...
$stages=afficher_satges();
while($stage = mysql_fetch_assoc($stages)){
echo "<tr><td width=\"20%\" class=\"xtr\"><p id=\"n".$stage['id']."\" >".$stage['nom']."</p></td><td width=\"50%\" class=\"xtr\"><p id=\"d".$stage['id']."\" >".$stage['description']."</p></td><td width=\"30%\" class=\"xtr\" ><a href=\"#\" id=\"".$stage['id']."\" onclick=\"select(this.id);\" >تغيير/حذف</a></td></tr>";
}
?>
</tbody></table>
<script>
...
document.getElementById('nomStageM').value=e;
document.getElementById('StageDescM').value=d;
document.getElementById('idstage').value=id;
document.getElementById('modif').style.visibility="visible";
}
</script>
</div><div id="modif" style="visibility:hidden;">
<form class="form-horizontal" action="" method="post">
<fieldset>

<!-- Form Name -->
<legend>تغيير تربص</legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="nomStage"> إسم التربص</label>  
  <div class="col-md-4">
  <input id="nomStageM" name="nomStageM" type="text" placeholder=" إسم التربص" class="form-control input-md" required="">
   <input type="hidden" id="idstage" name="idstage"> 
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textarea">المعطيات</label>
  <div class="col-md-4">                     
    <textarea class="form-control" id="StageDescM" name="StageDescM"></textarea>
  </div>
</div>
...
$nomStageM=$_POST['nomStageM'];
$StageDescM=$_POST['StageDescM'];
$idstage=$_POST['idstage'];
modifierStage($idstage,$nomStageM,$StageDescM);
}
if(isset($_POST['supprimer'])){
$idstage=$_POST['idstage'];
supprimerStage($idstage);
}
...
<table class="xtable" width="90%" id="AutoNumber1f5">
    <tbody>   
    <tr>
      <td width="40%" class="xtr"> الطفل </td>
      <td width="30%" class="xtd">التربص</td>
      <td width="30%" class="xtd"></td>
    </tr>

<?php
$demandesStage=afficher_demandes();
while($demande = mysql_fetch_assoc($demandesStage)){
echo "<tr><td width=\"40%\" class=\"xtr\"><p id=\"n".$demande['id']."\" >".$demande['prenom']." ".$demande['nom']." ".$demande['age']."سنة </p></td><td width=\"30%\" class=\"xtr\"><p >".$demande['id_stage']."</p></td><td width=\"30%\" class=\"xtr\" ><a href=\"#\" id=\"".$demande['id']."\" onclick=\"ajouter(this.id);\" >قبول/رفض</a></td></tr>";
}
?>
</tbody></table>
<div id="ajout" class="modif" style="visibility:hidden;">
<form class="form-horizontal" action="" method="post">
<fieldset>
<!-- Form Name -->
<legend>موافقة / رفض</legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="ajouter"></label>
  <div class="col-md-8">
    <button id="accepter" name="accepter" class="btn btn-success">موافق</button>
    <button id="refuser" name="refuser" class="btn btn-danger">رفض</button>
  </div>
</div>
<br>
</fieldset>
