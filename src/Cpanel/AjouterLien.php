...
<table class="xtable" width="90%" id="AutoNumber1f5">
    <tbody>   
    <tr>
      <td width="40%" class="xtr"> اللعبة </td>
...
<?php
$liensJeux=afficher_liensJeux();
while($lienJeux = mysql_fetch_assoc($liensJeux)){
echo "<tr><td width=\"40%\" class=\"xtr\"><p id=\"n".$lienJeux['id']."\" >".$lienJeux['nom']."</p></td><td width=\"30%\" class=\"xtr\"><p id=\"l".$lienJeux['id']."\" >".$lienJeux['url']."</p></td><td width=\"30%\" class=\"xtr\" ><a href=\"#\" id=\"".$lienJeux['id']."\" onclick=\"select(this.id);\" >تغيير/حذف</a></td></tr>";
}
?>
</tbody></table>
...
modifierLien($idlien,$nomlienM,$lienM);
}
